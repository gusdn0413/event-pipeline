...
class ApiLogExtractorTest {
    ...
    @Test
    @DisplayName("statusCode 200 + responseTime ≥ 1000 → SLOW")
    void classify_slow() {
        assertThat(extractor.extract(baseJson(200, 1200, null)).getEventType())
                .isEqualTo(EventType.SLOW);
    }
        ...
        return """
                {
                  ...
                  "responseTime": %d,
                  "header": { "token": "tok_test", "agent": "phone" },
